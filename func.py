...
errors = {
	...
	"véase_err" 	: "No ';' in CRP or CRP seems to be too long", #tested length on 1250 examples
...
def IE_NG_trouble_killer(IE_NG_part, CPR_part, sheet):
	...
	if "también" in CPR_part:
		...
		if IE_NG_part.count("*") <= 1 and (" g " not in IE_NG_part and "_g " not in IE_NG_part):	# g appears always as " g " or "_g "
